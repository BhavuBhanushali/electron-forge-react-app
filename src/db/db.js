...
let createLastLoginTable = "CREATE TABLE IF NOT EXISTS login (id SERIAL PRIMARY KEY, email VARCHAR(255), config TEXT, createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP);"
db.exec(createStudyTable);
db.exec(createLastLoginTable);
module.exports = { db }